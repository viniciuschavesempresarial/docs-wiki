...
export const EditorPage: React.FC = () => {
  ...
  return (
    <div id="page-editor" data-testid="page-editor" className="w-full max-w-full px-4 sm:px-6 lg:px-8 py-4 space-y-3 flex flex-col h-[calc(100vh-4.5rem)]">
      ...
      {isDeleteModalOpen && (
        <div id="modal-single-delete-backdrop" data-testid="modal-single-delete-backdrop" className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm animate-in fade-in">
          <div id="modal-single-delete" data-testid="modal-single-delete" className="bg-slate-900 border border-rose-500/30 rounded-2xl p-6 max-w-md w-full shadow-2xl space-y-4">
